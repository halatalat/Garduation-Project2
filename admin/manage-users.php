            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4" >
                        <h1 class="mt-4" style="text-align:center ;">إدارة المستخدمين</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                 <a href="add-user.php" class="btn btn-warning btn-round py-2  m-4" style="align:center"> إضافة موظف  </a>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                  ...
                                  <th>الرقم</th>
                                    ...
                                    <tbody>
                              <?php $ret=mysqli_query($con,"select * from employees");
                              $cnt=1;
