...
?>
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">عدد الموظفين  
                                ...
                                <?php
$query=mysqli_query($con,"select id from servicelist");
$totalserv=mysqli_num_rows($query);
?>

                            <div class="col-xl-6 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">عدد الخدمات المقدمة  
                                        <span style="font-size:22px;"> <?php echo $totalserv;?></span></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="manage-users.php"> عرض التفاصيل</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
