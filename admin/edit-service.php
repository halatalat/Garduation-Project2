...
if(isset($_POST['update']))
{
    ...
    $servid=$_GET['servid'];
    $msg=mysqli_query($con,"update servicelist set servname='$servname',detail='$detail',typeid='$type',price='$price',document='$requirement' where id='$servid'");
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                            ...
                            <?php 
                            $servid=$_GET['servid'];
                            $query1=mysqli_query($con,"select * from servicelist where id='$servid'");
                            ...
                            <div class="card-body">
                                <table class="table table-bordered" dir="rtl">
                                   ...
                                   <tr>
                                       <th>التفاصيل </th>
                                       <td>
                                       <input class="form-control" id="detail" name="detail" type="text" value="<?php echo $result['detail'];?>"  required />
                                    </td>
                                   </tr>
                                         <tr>
                                       <th>النوع</th>
                                   ...
                                   <tr>
                                       <th>المتطلبات</th>
                                       <td colspan="3"><input class="form-control" id="document" name="document" type="text" value="<?php echo $result['document'];?>"  required /></td>
                                   </tr>
