            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4" style="text-align:center ;">نتيجة تقارير المستخدمين</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">لوحة التحكم</a></li>
                            <li class="breadcrumb-item active">نتيجة تقارير المستخدمين</li>
                        </ol>
                        ...
                        <div class="card mb-4">
                            <div class="card-header " align="center" style="font-size:20px;">
                              ...
                              تقارير المستخدمين من الفتره <?php echo date("d-m-Y", strtotime($fdate));?> الي الفترة <?php echo date("d-m-Y", strtotime($tdate));?>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                  ...
                                  <th>الرقم</th>
                                    ...
                                    <tbody>
                            <?php $ret=mysqli_query($con,"select * from users where date(regDate) between '$fdate' and '$tdate'");
                              $cnt=1;
